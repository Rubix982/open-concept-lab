...
class ArxivDownloader:
    ...
    def __init__(self, rate_limit_seconds: float = 3.0):
        ...
        logger.info(f"Initialized ArxivDownloader with rate limit: {rate_limit_seconds}s")
    ...
    def download_pdf(self, paper: ArxivPaper, output_dir: str = "./papers") -> str | None:
        """
    ...
    def download_and_extract(self, paper: ArxivPaper, output_dir: str = "./papers") -> str | None:
        """
...
def get_curated_papers(collection: str) -> list[str]:
    """Get list of arXiv IDs for a curated collection."""
    return PAPER_COLLECTIONS.get(collection, [])
