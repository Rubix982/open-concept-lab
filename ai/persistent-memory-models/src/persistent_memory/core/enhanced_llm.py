...
class EnhancedLLM:
    ...
    def __init__(
        ...
        self.fact_extractor = FactExtractor(
            llm=self.llm, knowledge_graph=self.knowledge_graph
        )
    ...
    async def chat(
        ...
        if relevant_contexts:
            ...
            allocation, _ = self.context_allocator.allocate_context(
                user_input, relevant_contexts
            )
        ...
        if return_metadata:
            return {
                ...
                "quality_metrics": (
                    quality_metrics.__dict__ if quality_metrics else None
                ),
                "cached": False,
                "session_id": session_id,
            }
