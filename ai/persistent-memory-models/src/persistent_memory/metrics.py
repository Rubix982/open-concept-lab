...
ingestion_total = Counter(
    'persistent_memory_ingestion_total',
    'Total number of ingestion operations',
    ['status']
)

query_total = Counter(
    'persistent_memory_query_total',
    'Total number of query operations',
    ['layer']
)

fact_extraction_total = Counter(
    'persistent_memory_fact_extraction_total',
...
ingestion_duration = Histogram(
    'persistent_memory_ingestion_duration_seconds',
    'Time spent on ingestion operations'
)

query_duration = Histogram(
    'persistent_memory_query_duration_seconds',
    'Time spent on query operations',
    ['layer']
)

llm_call_duration = Histogram(
    'persistent_memory_llm_call_duration_seconds',
    'Time spent on LLM API calls'
)

# Gauges
vector_store_size = Gauge(
    'persistent_memory_vector_store_size',
    'Number of items in vector store'
)

knowledge_graph_nodes = Gauge(
    'persistent_memory_knowledge_graph_nodes',
    'Number of nodes in knowledge graph'
)

knowledge_graph_edges = Gauge(
    'persistent_memory_knowledge_graph_edges',
