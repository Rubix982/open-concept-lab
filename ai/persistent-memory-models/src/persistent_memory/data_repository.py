...
class DataRepository:
    ...
    def get_paper(self, arxiv_id: str, force_download: bool = False) -> dict[str, Any] | None:
        """
    ...
    def get_papers_batch(
        self, arxiv_ids: list[str], force_download: bool = False
    ) -> list[dict[str, Any]]:
    ...
    def search_and_cache(self, query: str, max_results: int = 10) -> list[dict[str, Any]]:
        """
    ...
    def get_pdf_path(self, arxiv_id: str) -> str | None:
    ...
    def clear_cache(self, arxiv_id: str | None = None):
    ...
    def _download_and_store(self, arxiv_id: str) -> dict[str, Any] | None:
    ...
    def _load_cached_paper(self, arxiv_id: str) -> dict[str, Any] | None:
