...
class PersistentContextEngine:
    ...
    def __init__(self):
        ...
        self.episodic = PersistentVectorStore(index_type="HNSW", dimension=1536, metric="cosine")
        ...
        self.archive = CompressedContextStore(compression="autoencoder", retrieval_threshold=0.7)
