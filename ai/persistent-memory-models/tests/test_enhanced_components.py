...
import pytest
import numpy as np
from persistent_memory.context_quality_monitor import ContextQualityMonitor, QualityMetrics
from persistent_memory.dynamic_context_allocator import DynamicContextAllocator, AllocationStrategy
...
class TestDynamicContextAllocator:
    ...
    def test_complexity_estimation(self):
        ...
        # Medium query
        assert allocator._estimate_complexity(
    ...
    def test_context_allocation(self):
        ...
        allocated, buffer = allocator.allocate_context(
            "Simple query",
            contexts
        )
