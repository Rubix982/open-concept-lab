...
def main():
    ...
    print("   (Main aapka personal research assistant hoon)")
    print("=" * 60)
    print("I can help you find, read, and remember research papers.")
    print("Let's see what I can do...\n")

    # 1. Search arXiv
    print("🔍 STEP 1: Searching the internet (arXiv) for papers...")
    print("   Query: 'hierarchical attention'")
