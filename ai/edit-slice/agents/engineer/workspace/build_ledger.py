...
#: Structured twin of the page above, for <Evidence id="E-016" /> to resolve against.
#: Emitted from the SAME parse, so the component and the page cannot disagree — which was
#: the objection to keeping a separate evidence/*.yml by hand.
DATA = ROOT.parents[1] / "web" / "data" / "evidence.yml"
...
def main() -> None:
    ...
    Y = ["# Generated by agents/engineer/workspace/build_ledger.py — do not edit.",
         "# The record lives in agents/shared/*.md and threads.md; this is its index,",
         "# emitted from the same parse as notebook/edit-slice/ledger.md so the two",
         "# cannot drift. Consumed by <Evidence id=\"E-016\" />.",
         ""]
    for e in dec:
